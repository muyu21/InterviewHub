...
public class Main {
    ...
    static String apiKey = "79380c77-1acf-4d99-95b3-bbc65c65ea64";
    ...
    public static void main(String[] args) {
        ...
        final ChatMessage systemMessage = ChatMessage.builder().role(ChatMessageRole.SYSTEM).content("你是一名Java后端程序员").build();
        final ChatMessage userMessage = ChatMessage.builder().role(ChatMessageRole.USER).content("帮我生成 20 道 Java面试题").build();
